      ...
      <div id="hero">
        <div id="left">
          <div id="herotext">
            ...
            <span className="intro_sub">
              Search our entire store in <span id="location">{loc}</span>
              <Down
                id="drop"
                onClick={locationToggle}
                className={open ? "rotate" : null}
              />
            </span>
          </div>

          <div id="search_container">
            <Cat_btn id="cat_btn" onClick={catToggle} />{" "}
            <div id="separator"></div> <Search_btn id="search_btn" />
